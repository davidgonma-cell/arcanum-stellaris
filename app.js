...
(function () {
  ...
  function renderCard3D(card, idx) {
    ...
    const imageURL = (typeof getCardImageURL === 'function')
      ? getCardImageURL(card, 600) : null;
    ...
    if (imageURL && card.arcana === 'major') {
      useImage = true;
      // SVG fallback como capa base + img encima. Si falla la imagen → onerror la oculta.
      frontArt = `
